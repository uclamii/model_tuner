from model_tuner import Model, report_model_metrics, evaluate_bootstrap_metrics
...
model_definitions = {xgb_name: xgb_definition}
...
################################################################################
######################## Evaluate Bootstrap Metrics ############################

print("Bootstrap metrics for XGB \n")
print(
